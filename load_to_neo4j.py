...
def load_data():
    ...
    # print("stm_metro_route.csv completed")
    ...
    # print("stm_bus_route.csv completed")
    ...
    # print("stm_bus_stop.csv completed")
    ...
    # print("stm_metro_stop.csv completed")
...
#     load_csv_to_neo4j(neo4j_driver, "stm_metro_trip.csv", load_metro_trip_query)
    # print("stm_metro_trip.csv completed")
    ...
    # print("stm_bus_trip.csv completed")
    ...
    # print("stm_metro_stop_time.csv completed")
    ...
    # print("stm_bus_stop_time.csv completed")
    ...
    # print("stm_metro_planned_kilometerage.csv completed")
    ...
    # print("stm_metro_realized_kilometerage.csv completed")
    ...
    # print("stm_incident.csv completed")
    ...
    # print("live_stm_bus_trip.csv completed")
    ...
    # print("live_stm_bus_trip_stop.csv completed")
